...
public:
	...
	virtual bool GetIgnoreCaption() const { return false; };
	...
	void SetFocusedBkColor(DWORD dwBackColor);
	bool GetVGradient() const;
	void SetVGradient(bool bVGradient);

	//蒙版色
	DWORD GetMaskStartColor() const;
	void SetMaskStartColor(DWORD dwMaskStartColor);
	DWORD GetMaskEndColor() const;
	void SetMaskEndColor(DWORD dwMaskEndColor);
	DWORD GetGradient2Percent() const;
	void SetGradient2Percent(DWORD dwGradient2Percent);
...
protected:
	...
	bool m_bVGradient;//垂直渐变
	DWORD m_dwGradient2Percent;//渐变百颜色2百分比位置 0~100 m默认50 m_dwMaskEndColor终点位置
	DWORD m_dwMaskStartColor;
	DWORD m_dwMaskEndColor;

	DWORD m_dwFocusedBackColor;
    DWORD m_dwBackColor;
