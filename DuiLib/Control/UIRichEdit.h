...
public:
	...
	DWORD GetPlaceholderTextColor();
	void SetPlaceholderTextColor(DWORD dwPlaceholderTextColor);
	CDuiString GetPlaceholderText();
	void SetPlaceholderText(LPCTSTR pstrPlaceholderText);
    int GetLimitText();
	...
	bool CanUndo();
	bool GetSel(DWORD& dwBegin, DWORD& dwEnd);
	...
	RECT GetPlaceholderPadding() const;
	void SetPlaceholderPadding(RECT rc);
