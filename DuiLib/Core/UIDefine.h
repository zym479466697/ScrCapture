...
#define DUI_MSGTYPE_ITEMCLICK_FINISHED 	   (_T("itemclickfinished"))
...
#define DUI_MSGTYPE_BTNENTER			   (_T("btnenter"))
#define DUI_MSGTYPE_BTNLEAVE			   (_T("btnleave"))
...
#define  DUI_CTR_MACPROGRESS					 (_T("MacProgress"))
