...
namespace DuiLib
{
	...
	public:
		...
		void SetHotBkColor2(DWORD dwColor);
		DWORD GetHotBkColor2() const;
		void SetHotBkColor3(DWORD dwColor);
		DWORD GetHotBkColor3() const;
	...
	protected:
		...
		DWORD m_dwHotBkColor2;
		DWORD m_dwHotBkColor3;
