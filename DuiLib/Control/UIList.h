...
class ImpPosChangeCallBack
{
public:
	~ImpPosChangeCallBack(){}
	virtual void OnSizeChange(CListHBoxElementUI* pListElement)=0;
};
...
public:
    ...
    void SetPos(RECT rc, bool bNeedInvalidate = true);
    bool DoPaint(HDC hDC, const RECT& rcPaint, CControlUI* pStopControl);
	void SetCallBackObj(ImpPosChangeCallBack* pCallBack);
private:
	ImpPosChangeCallBack *m_pCallBack;
};
